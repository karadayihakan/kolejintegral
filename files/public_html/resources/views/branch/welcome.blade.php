...
<head>
  ...
  <title>EN Deneyim Merkezi | {{ $branch->name }}</title>
...
<body>
    ...
    <div class="top-nav">
      <div class="container">
        <div class="top-nav-left">
          ...
          <div class="top-nav-left__item">
            <a href="https://wa.me/9{{ $branch->phone }}" style="text-decoration: none" target="_blank">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="top-nav-right">
          ...
          <a target="_blank" href="{{ $branch->slug === 'merkez' ? 'https://www.instagram.com/endeneyim?igsh=MTVzMGVzbWl2MnQzeA==' : ($branch->slug === 'besiktas' ? 'https://www.instagram.com/endeneyimbesiktas?igsh=MXhodnlxbnc0eGw3cg==' : ($branch->slug === 'malatya' ? 'https://www.instagram.com/endeneyim.malatya?igsh=MTk0eTBzOHEzZ3NlZw==' : '')) }}">
      ...
      <div class="swiper-wrapper">
        <!-- Slides -->
         @if($branch->slug == "malatya")
          <div class="swiper-slide" style="background-image: url('/images/branches/malatya.jpg');">
            <div class="container">
         ...
         @else
          <div class="swiper-slide" style="background-image: url('/images/branches/besiktas.jpg');">
            <div class="container">
              <div class="class-item" style="margin-bottom: 25px;">
                <img src="/storage/{{ $branch->logo }}" alt="" width="228" height="197">
              </div>
        ...
        <div class="swiper-slide" style="background-image: url('/images/branches/ic1.jpg');">
            <div class="container">
              <div class="class-item" style="margin-bottom: 25px;">
                <img src="/storage/{{ $branch->logo }}" alt="" width="228" height="197">
              </div>
          ...
          <div class="swiper-slide" style="background-image: url('/images/branches/ic2.jpg');">
            <div class="container">
              <div class="class-item" style="margin-bottom: 25px;">
                <img src="/storage/{{ $branch->logo }}" alt="" width="228" height="197">
              </div>
  ...
  <div class="contact" id="contact">
    <div class="container">
      <h2 style="text-transform: uppercase;">EN DENEYİM MERKEZİ | {{ $branch->name }}</h2>
