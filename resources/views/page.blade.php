...
<body>
    ...
    <div class="top-nav">
      <div class="container">
        <div class="top-nav-left">
          <a href="tel:{{ preg_replace('/[^0-9]/', '', !empty($settings['phone']) ? $settings['phone'] : '0212 555 1234') }}" class="top-nav-left__item" style="text-decoration: none;">
            ...
            <p style="color: inherit; text-decoration: none; margin: 0;">{{ !empty($settings['phone']) ? $settings['phone'] : '0212 555 1234' }}</p>
          </a>
          <a href="mailto:{{ isset($settings['email']) && $settings['email'] ? $settings['email'] : 'info@kolejintegral.com' }}" class="top-nav-left__item" style="text-decoration: none;">
            <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p style="color: inherit; text-decoration: none; margin: 0;">{{ isset($settings['email']) && $settings['email'] ? $settings['email'] : 'info@kolejintegral.com' }}</p>
          </a>
        </div>
  ...
  <section style="width: 100%; background-color: #51223a; padding: 0; margin-top: 200px;">
    <div style="width: 100%; background-color: white; padding: 20px 0;">
      <h1 style="color: #0d1331; font-size: 32px; font-weight: bold; margin: 0; text-align: center; text-transform: uppercase;">
        {{ $page->title }}
      </h1>
    </div>
      ...
      <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 40px 20px;">
        ...
        @else
          <div style="text-align: center; color: #666; padding: 40px;">
            <p style="font-size: 18px;">İçerik henüz eklenmemiş.</p>
          </div>
        @endif
